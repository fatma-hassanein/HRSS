...
public class ListViewSwipeGesture implements OnTouchListener {
    ...
    String RangeOneColor="#f72727";   //"#FFD060"
    ...
    private void GetResourcesValues() {
        ...
        HalfText            =   activity.getResources().getString(R.string.reject);
        HalfTextFinal         =   activity.getResources().getString(R.string.reject);
        FullText            =   activity.getResources().getString(R.string.accept);
        FullTextFinal         =   activity.getResources().getString(R.string.accept);
